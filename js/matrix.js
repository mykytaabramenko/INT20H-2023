...
const randomGlyph = () => {
  return {
	...
	flipped: 0,
	bright: 0 // Math.random() < brightRatio
  };
};
...
const universe = makeUniverse(100);
...
// SASHA YOU CAN PLAY WITH THIS COLORS
const rgb = "#008000";
const rgbBright = "#008000"; // "#20E020";
const rgbHead = ["#008000", "##008000", "##008000", "##008000"];
const rgbTail = ["#000500", "#003000", "#005000", "#007000"];

// HERE IS THE END OF THE PART YOU CAN PLAY WITH
